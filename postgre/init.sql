...
FROM '/data-preprocess/data/movies.csv' DELIMITER ',' CSV HEADER;
...
FROM '/data-preprocess/data/ratings_small.csv' DELIMITER ',' CSV HEADER;
...
FROM '/data-preprocess/data/cast_info.csv' DELIMITER ',' CSV HEADER;
...
FROM '/data-preprocess/data/crew_info.csv' DELIMITER ',' CSV HEADER;
...
FROM '/data-preprocess/data/cast_movie_relationship.csv' DELIMITER ',' CSV HEADER;
...
FROM '/data-preprocess/data/crew_movie_relationship.csv' DELIMITER ',' CSV HEADER;